...
def render_deprivation_playground():
    ...
    st.markdown(
        ...
        /* Hide the sidebar column on mobile/tablet screens, and make content 100% wide */
    ...
    st.markdown(
        '<div class="page-title">Deprivation Analysis Playground</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
        '<div class="page-body">Explore correlations and distribution patterns across IMD 2025 deprivation domains — across England and within the East of England region.</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
        """
    ...
    with col_sidebar:
        ...
        _ra_module.render_research_assistant_widget(key_suffix="dep_sidebar")
...
def _render_deprivation_cancer_scatter(imd_df):
