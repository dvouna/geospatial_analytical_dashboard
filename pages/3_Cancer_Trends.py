    ...
    with tab_trends:
        ...
        if raw_cancer_df.empty:
            ...
            if not sel_trend_districts:
                ...
                st.plotly_chart(fig_trend, use_container_width=True, config={"displayModeBar": not get_is_mobile()})
            ...
            if not sel_districts:
                ...
                if filt.empty:
                    ...
                    if len(sel_districts) == 1:
                        ...
                        st.plotly_chart(fig, width="stretch", config={"displayModeBar": not get_is_mobile()})
                    ...
                    if not melted.empty:
                        ...
                        st.plotly_chart(fig2, width="stretch", config={"displayModeBar": not get_is_mobile()})
