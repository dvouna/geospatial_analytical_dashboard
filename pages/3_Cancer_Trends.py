...
def render_cancer_trends():
    ...
    st.markdown(
        '<div class="page-title">Cancer Trends Analysis Playground</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
        '<div class="page-body">Compare oncology rates, age profiles, confidence intervals, and cancer type compositions across East of England districts.</div>',
        unsafe_allow_html=True,
    )
    ...
    with col_sidebar:
        ...
        _ra_module.render_research_assistant_widget(key_suffix="cancer_sidebar")
                ...
                if comp_mode == "Specific Cancer Rates":
                    ...
                    if len(selected_districts) == 1:
                        ...
                        fig = px.bar(
                            ...
                            category_orders={
                                "Cancer Type": [c.capitalize() for c in CANCER_TYPES]
                            },
                        )
                        fig.update_layout(
                            height=450,
                        ...
                        st.plotly_chart(
                            ...
                            config={"displayModeBar": not get_is_mobile()},
                        )
                    else:
                    ...
                    if (
                        ...
                        fig.add_trace(
                            go.Scatter(
                                ...
                                mode="markers",
                                marker=dict(size=12, color="#E63946", symbol="diamond"),
    ...
    with tab_trends:
        ...
        if raw_cancer_df.empty:
            ...
            cancers_available = sorted(raw_cancer_df["Cancer Type"].unique().tolist())
            ...
            if not sel_trend_districts:
                ...
                try:
                    ...
                    grouped_trend["fid"] = grouped_trend["fid"].astype(str).str.strip()
